    ...
    <>
      ...
      <main className="min-h-screen">
        <section className="py-20 px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto">
          <Link href="/projects" className="text-[var(--primary)] hover:underline mb-8 inline-block">
            ← Back to projects
          </Link>
          ...
          >
              ...
              <ul className="space-y-2">
                {project.highlights.map((highlight: string) => (
                  <li key={highlight} className="text-gray-600 dark:text-gray-400 flex items-start">
                    <span className="text-[var(--primary)] mr-3 font-bold">✓</span>
                    {highlight}
                  </li>
                ))}
              </ul>
            ...
            <div className="text-center py-12 border-t border-gray-200 dark:border-gray-800">
              ...
              <Link
                href="/contact"
                className="inline-block px-8 py-3 bg-[var(--primary)] text-white rounded-lg hover:bg-[var(--primary-hover)] transition-colors font-semibold"
              >
                Get in Touch
              </Link>
            </div>
